...
using Documenter: Documenter, MarkdownAST, AbstractTrees, render, expand, walk_navpages
...
@static if isdefined(Base, :get_extension)
    ...
    @testset "Online githubcheck" begin
        @testset "Success" begin
            ...
            # No error on check
            @test GitHubCheckExt.githubcheck(doc) === nothing
        ...
        @testset "Failure" begin
            ...
            @test_logs (:error,) @test GitHubCheckExt.githubcheck(doc) === nothing
